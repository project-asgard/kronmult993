...
#include "../algo-origin/kronmult/pbatched/kronmult1_pbatched.hpp"
#include "../algo-origin/kronmult/pbatched/kronmult2_pbatched.hpp"
#include "../algo-origin/kronmult/pbatched/kronmult3_pbatched.hpp"
#include "../algo-origin/kronmult/pbatched/kronmult4_pbatched.hpp"
#include "../algo-origin/kronmult/pbatched/kronmult5_pbatched.hpp"
#include "../algo-origin/kronmult/pbatched/kronmult6_pbatched.hpp"
...
template<typename T>
T test_kronmult_pbatched(int const idim, int const n, int const batchCount, int const idebug = 0,
...
#pragma omp parallel for
...
#ifdef USE_GPU
    {
        ...
        {
        case 1:
            kronmult1_pbatched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 2:
            kronmult2_pbatched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 3:
            kronmult3_pbatched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 4:
            kronmult4_pbatched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 5:
            kronmult5_pbatched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 6:
            kronmult6_pbatched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        default:
            assert(false);
...

    {
        ...
        {
        case 1:
            kronmult1_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 2:
            kronmult2_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 3:
            kronmult3_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 4:
            kronmult4_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 5:
            kronmult5_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        case 6:
            kronmult6_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
            break;
        default:
            assert(false);
        };
