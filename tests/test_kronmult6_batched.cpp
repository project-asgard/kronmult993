...
template<typename T>
T test_kronmult_batched(int const idim, int const n, int const batchCount, int const idebug = 0,
...
#pragma omp parallel for
...
#ifdef USE_GPU
    {
        ...
        case 1:
            kronmult1_batched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
            break;
        case 2:
            kronmult2_batched<T>
                <<<batchCount, nthreads>>>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
...

    {
        ...
        {
        case 1:
            kronmult1_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
            break;
        case 2:
            kronmult2_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
            break;
        case 3:
            kronmult3_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
            break;
        case 4:
            kronmult4_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
            break;
        case 5:
            kronmult5_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
            break;
        case 6:
            kronmult6_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
            break;
        default:
            assert(false);
        };
