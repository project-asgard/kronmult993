...
kgemm_nn_batched(int const mm, int const nn, int const kk, T const alpha, T *const Aarray_[],
                 int const ldAarray_[], T *const Barray_[], int const ldBarray_[], T const beta,
                 T *const Carray_[], int const ldCarray_[], int const batchCount)
{
    // ----------------------------
