...
//  -------------------------------------------
template<typename T>
DEVICE_FUNCTION void kronmult5(int const n, int const nvec, T const A1_[], T const A2_[], T const A3_[],
                               T const A4_[], T const A5_[], T X_[], T Y_[], T W_[], int const lda_in = 0)
// -----------------
// note A1 is n by n
//      X is (n^5 by nvec)
// -----------------
